...
var budgetController = (function(){
    ...
    return{
        addItem: function(type, des, val){
            ...
            //create new item according to its type
            if( type==="exp" ){
...
var UIController = (function(){
    ...
    return {
        ...
        displayBudget: function(obj){
            var type;
            obj.budget > 0 ? type = "inc" : tpye = "exp" ; 
        ...
        changeType: function() {
            ...
            var fields = document.querySelectorAll(DOMstrings.inputType + "," + DOMstrings.inputDescription + "," + DOMstrings.inputDescription + "," + DOMstrings.inputValue);
...
var controller = (function(budgetCtrl, UICtrl){
    ...
    var ctrlAddItem = function(){
        ...
        if(input.description !=="" && !isNaN(input.value) && input.value>0){
            ...
            //6. update percentages with new values
            updatePercentages();
        }
